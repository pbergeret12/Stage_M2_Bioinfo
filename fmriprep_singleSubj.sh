...
#User inputs:
bids_root_dir="/home/pierreb/Documents/testfmri"
subj=1002
nthreads=4
mem=20 #gb
...
export FS_LICENSE="/home/pierreb/Desktop/Flanker/derivatives/license.txt"
#Run fmriprep
if [ $container == singularity ]; then
  ...
  fmriprep-docker $bids_root_dir $bids_root_dir/derivatives \
    ...
    --skip-bids-validation \
    --md-only-boilerplate \
    --fs-license-file /home/pierreb/Desktop/Flanker/derivatives/license.txt \
    --fs-no-reconall \
    --output-spaces MNI152NLin2009cAsym:res-2 \
    --nthreads $nthreads \
    --stop-on-first-crash \
    --mem_mb $mem_mb\
    -w /home/pierreb/Desktop/test_results
fi
