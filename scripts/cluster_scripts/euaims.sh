...
#export PATH="$HOME/.local/bin:$PATH" : à runner dans le terminal pour faire fonctionner fmriprep-docker
#attention, le sudo peut empêcher le sript de fonctionner.

#User inputs:
bids_root_dir="$HOME/Documents/brut_data/EU_AIMS"
#nb Coeur CPU:
nthreads=8
mem=20 #gb
...
#Run fmriprep selon docker ou sngularity
